...
export default function GigsPage() {
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <h1 className="text-4xl font-extrabold mb-8 select-none">Available Gigs</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {gigs.map((gig) => {
          const thumb = gig.gigThumbnail;
          // Display lowest price tier if available
          ...
          return (
            ...
            >
              ...
              <span className="text-indigo-600 text-lg font-semibold mb-4">
                ₹{displayPrice}
              </span>
